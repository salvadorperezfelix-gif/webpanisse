...
trim_and_pad(f"{base_src}/DÖRT (2).png", f"{base_out}/panisse-boutique-bordeaux-1.jpg", pad_pct=0.25)
trim_and_pad(f"{base_src}/DÖRT (1).png", f"{base_out}/panisse-boutique-bordeaux-2.jpg", pad_pct=0.28)
