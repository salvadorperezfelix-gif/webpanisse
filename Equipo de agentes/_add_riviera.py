...
trim_and_pad(f"{base_src}/İKİMCİ (2).png", f"{base_out}/panisse-riviera-1.jpg", pad_pct=0.22)
trim_and_pad(f"{base_src}/İKİMCİ (1).png", f"{base_out}/panisse-riviera-2.jpg", pad_pct=0.25)
