...
# mavi (1) = frontal → 1.jpg (principal)
process(os.path.join(SRC_DIR, "mavi (1).png"), os.path.join(DST_DIR, "panisse-sete-1.jpg"))
# mavi (2) = ángulo → 2.jpg
process(os.path.join(SRC_DIR, "mavi (2).png"), os.path.join(DST_DIR, "panisse-sete-2.jpg"))
