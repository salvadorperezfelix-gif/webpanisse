...
# POLA (1) = frontal → 1.jpg (principal)
process(os.path.join(SRC_DIR, "POLA (1).png"), os.path.join(DST_DIR, "polaroid-pld6247-1.jpg"))
# POLA (2) = ángulo → 2.jpg
process(os.path.join(SRC_DIR, "POLA (2).png"), os.path.join(DST_DIR, "polaroid-pld6247-2.jpg"))
