...
# KADDD.png = frontal → 1.jpg (principal)
process(os.path.join(SRC_DIR, "KADDD.png"), os.path.join(DST_DIR, "polaroid-pld6251-1.jpg"))
# KADDD.jpeg = ángulo → 2.jpg
process(os.path.join(SRC_DIR, "KADDD.jpeg"), os.path.join(DST_DIR, "polaroid-pld6251-2.jpg"))
