...
# GOZLUK (2) = frontal → 1.jpg (principal)
process(os.path.join(SRC_DIR, "GOZLUK (2).jpg"), os.path.join(DST_DIR, "polaroid-pld6241-1.jpg"))
# GOZLUK (1) = ángulo → 2.jpg
process(os.path.join(SRC_DIR, "GOZLUK (1).jpg"), os.path.join(DST_DIR, "polaroid-pld6241-2.jpg"))
