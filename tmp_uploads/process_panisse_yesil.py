...
SRC_DIR = r"C:\Users\Panisse Óptica Lugo\Desktop\panis"
DST_DIR = r"C:\Users\Panisse Óptica Lugo\Desktop\Web Panisse\assets\img\products\panisse"
...
# yesil (2) = frontal → 1.jpg (principal)
process(os.path.join(SRC_DIR, "yesil (2).png"), os.path.join(DST_DIR, "panisse-boutique-menton-1.jpg"))
# yesil (1) = ángulo → 2.jpg
process(os.path.join(SRC_DIR, "yesil (1).png"), os.path.join(DST_DIR, "panisse-boutique-menton-2.jpg"))
