...
# DISSS (2) = frontal → 1.jpg (principal)
process(os.path.join(SRC_DIR, "DISSS (2).jpeg"), os.path.join(DST_DIR, "polaroid-diss-1.jpg"))
# DISSS (1) = ángulo → 2.jpg
process(os.path.join(SRC_DIR, "DISSS (1).jpeg"), os.path.join(DST_DIR, "polaroid-diss-2.jpg"))
