...
# HHHH (1) = frontal → 1.jpg (principal)
process(os.path.join(SRC_DIR, "HHHH (1).jpeg"), os.path.join(DST_DIR, "polaroid-pld4190-1.jpg"))
# HHHH (2) = ángulo → 2.jpg
process(os.path.join(SRC_DIR, "HHHH (2).jpeg"), os.path.join(DST_DIR, "polaroid-pld4190-2.jpg"))
