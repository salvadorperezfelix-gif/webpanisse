...
# PEMPE (2) = frontal → 1.jpg (principal)
process(os.path.join(SRC_DIR, "PEMPE (2).jpeg"), os.path.join(DST_DIR, "polaroid-pld5969-1.jpg"))
# PEMPE (1) = ángulo → 2.jpg
process(os.path.join(SRC_DIR, "PEMPE (1).jpeg"), os.path.join(DST_DIR, "polaroid-pld5969-2.jpg"))
