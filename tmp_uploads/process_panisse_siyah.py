...
# siyah (1) = frontal → 1.jpg (principal)
process(os.path.join(SRC_DIR, "siyah (1).png"), os.path.join(DST_DIR, "panisse-collioure-1.jpg"))
# siyah (2) = ángulo → 2.jpg
process(os.path.join(SRC_DIR, "siyah (2).png"), os.path.join(DST_DIR, "panisse-collioure-2.jpg"))
