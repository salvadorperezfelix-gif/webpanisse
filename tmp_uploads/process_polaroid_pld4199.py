...
# LEO (1) = frontal → 1.jpg (principal)
process(os.path.join(SRC_DIR, "LEO (1).jpg"), os.path.join(DST_DIR, "polaroid-pld4199-1.jpg"))
# LEO (2) = ángulo → 2.jpg
process(os.path.join(SRC_DIR, "LEO (2).jpg"), os.path.join(DST_DIR, "polaroid-pld4199-2.jpg"))
