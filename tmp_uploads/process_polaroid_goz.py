...
# GOZ.png = frontal → 1.jpg (principal)
process(os.path.join(SRC_DIR, "GOZ.png"), os.path.join(DST_DIR, "polaroid-pld6249-1.jpg"))
# GOZ.jpg = ángulo → 2.jpg
process(os.path.join(SRC_DIR, "GOZ.jpg"), os.path.join(DST_DIR, "polaroid-pld6249-2.jpg"))
